	...
	// check whether the payment_status is Completed
	         ...
	         // assign posted variables to local variables, apply urldecode to them all at this point as well, makes things simpler later
                ...
                if($payment_status == 'Completed')
                {
						...
						$subject = 'the subject';
						$message = 'hello please click <a href="wwww.stepstolifeclasses.com/'.$item_number.'.html">Meal Plan 1- 1800 download </a>';
						$headers = 'From: stepstolifenow.com' . "\r\n" .
    					'Reply-To: stepstolifenow@gmail.com' . "\r\n" .
